            ...
            <form role="form" id="editForm">
            	<div class="col-sm-12 modal-body form-horizontal">
					<input type="hidden" name="id" class="form-control">
                  	...
                  	<div class="form-group">
                		<label class="col-sm-2 lh34 text-right" for="groupCategoryId">分类</label>
                     	<div class="col-sm-8">
                     		<select class="form-control" id = "groupCategoryId" name="groupCategoryId">
...
<script>
	function edit(id){
	    $.ajax({
	    	url:"/manager/groupsubcategory/edit.do?id="+id,
	    	type:"POST",
	    	success:function(res){
    		    ...
    		    $('#editModal').find("#groupCategoryId option[value='"+data.groupCategoryId+"']").attr("selected", true);
	    	},
	    	error:function(){
	    		alert("操作失败");
	    	}
