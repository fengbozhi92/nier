                	...
                	<form id="formSearch" class="form-horizontal">
                    	<div class="form-group" style="margin-top:15px">
	                        ...
	                        <div class="col-sm-2">
	                         ...
	                         <label class="control-label col-sm-1" for="search_parentId">上级</label>
	                        <div class="col-sm-2">
	                            <select class="form-control" id="search_parentId">
...
/*	    		rowStyle: function (row, index) {
	    		...
	    		columns: [{
	                ...
	                align : 'center',
	                formatter : function (value, row, index){
	                	var result = '<button class="btn btn-default btn-xs edit" type="button" onclick="edit(\''+row.id+'\');"><span class="glyphicon glyphicon-plus"></span>新增</button>'
