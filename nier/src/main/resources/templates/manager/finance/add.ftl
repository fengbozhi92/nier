    	...
    	<div class="modal-content">
            ...
            <form role="form" id="addForm">
            	<div class="col-sm-12 modal-body form-horizontal">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 lh34 text-right" for="name">初始资产</label>
                        <div class="col-sm-8">
                            <input type="text" name="residue" class="form-control" id="residue" placeholder="名称">
                        </div>
                    </div>
             	</div>
            </form>
