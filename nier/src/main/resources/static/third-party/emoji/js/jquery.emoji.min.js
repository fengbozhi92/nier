!function(a,b,c){
	function d(b,c){
		...
		case"none":this.showFunc="show",this.hideFunc="hide",this.toggleFunc="toggle";
			break;
		case"slide":this.showFunc="slideDown",this.hideFunc="slideUp",this.toggleFunc="slideToggle";
			break;
		case"fade":this.showFunc="fadeIn",this.hideFunc="fadeOut",this.toggleFunc="fadeToggle";
			break;
		default:this.showFunc="fadeIn",this.hideFunc="fadeOut",this.toggleFunc="fadeToggle"}this._init()
	}
	function e(b){
	...
	var f="emoji",
		g={showTab:!0,animation:"fade",icons:[]};
	b.emoji_index=0,
	d.prototype={
			_init:function(){
				var b,d,e,f,g,
				...
				i||(b='<input type="image" class="emoji_btn" id="emoji_btn_'+j+'" src="data:image/png;base64,"/>',
					...
					a(b).appendTo(a("body")),
					a("#emoji_btn_"+j).css({top:d+"px",left:e+"px"}),
					i="#emoji_btn_"+j);
				var k=this.options.showTab,
					l=this.options.icons,
					m=l.length;
				if(0===m)return alert("Missing icons config!"),!1;
				for(var n,o,p,q,r,s,t,u,v,w,x,
						y='<div class="emoji_container" id="emoji_container_'+j+'">',
						z='<div class="emoji_content">',
						A='<div class="emoji_tab" style="'+(1!==m||k?"":"display:none;")+'"><div class="emoji_tab_prev"></div><div class="emoji_tab_list"><ul>',
						B=0;
					m>B;
					B++
				)
				...
				y+=z,y+=A,y+=D,a(y).appendTo(a("body")),f=a(i).offset().top+a(i).outerHeight()+5,g=a(i).offset().left,
				a("#emoji_container_"+j).css({top:f+"px",left:g+"px"}),
				a("#emoji_container_"+j+" .emoji_content").mCustomScrollbar({
					theme:"minimal-dark",scrollbarPosition:"inside",mouseWheel:{scrollAmount:275}
				});
				var E=m%8===0?parseInt(m/8):parseInt(m/8)+1,F=1;a(c).on({
					click:function(b){
