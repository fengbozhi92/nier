 ...
 * 中文转拼音首字母
 */
public class ChineseDictionaryUtils {
    ...
    public static Map<Character, Character> dictionaryMap  = new HashMap<Character, Character>();

	static {
		for (String str : dictionary) {
			char[] chs = str.toCharArray();
			for (int i = 1; i < chs.length; i++) {
			    dictionaryMap.put(chs[i], chs[0]);
			}
		}
	}
	...
	public static String firstCHAR(String str) {
		...
		for (int i = 0; i < str.length(); i++) {
			...
			if (dictionaryMap.containsKey(ch)) {
				sb.append(dictionaryMap.get(ch));
			} else {
				sb.append(ch);
			}
		}
	...
	public static String firstChar(String str) {
		return firstCHAR(str).toLowerCase();
	}

	public static void main(String[] args) {
		System.out.println(firstChar("冯博智"));
	}
}